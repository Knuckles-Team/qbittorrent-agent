...
# Paths
ROOT_DIR = "/home/apps/workspace/agent-packages/agents/qbittorrent-agent"
...
def test_concept_parity():
    """
    Enforces that all concepts documented or used in qbittorrent-agent
    ...
    assert not unregistered_concepts, (
        f"The following concepts are used in qbittorrent-agent but are NOT registered "
