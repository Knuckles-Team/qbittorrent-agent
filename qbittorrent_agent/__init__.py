...
_MCP_AVAILABLE = OPTIONAL_MODULES.get("qbittorrent_agent.mcp_server") in [
    m.__name__ for m in globals().values() if hasattr(m, "__name__")
]
_AGENT_AVAILABLE = "qbittorrent_agent.agent_server" in globals()
